...
TEST_F(SchemeUniqueIdentifiersTest, DefineVariableReplacement)
{
  ...
  ASSERT_TRUE(opi::isnum(var_value));
  EXPECT_EQ(opi::num_val(var_value), 42.0);
}
...
TEST_F(SchemeUniqueIdentifiersTest, LetVariableReplacement)
{
  ...
  ASSERT_TRUE(opi::ispair(bindings));

  // Check the first binding (x 1)
  opi::value binding_x = opi::car(bindings);
  ASSERT_TRUE(opi::ispair(binding_x));
  ...
  ASSERT_TRUE(opi::ispair(binding_y));
...
TEST_F(SchemeUniqueIdentifiersTest, LetrecVariableReplacement)
{
  ...
  ASSERT_TRUE(opi::ispair(binding_fact));
  ...
  ASSERT_TRUE(opi::ispair(lambda_body));
...
TEST_F(SchemeUniqueIdentifiersTest, FunctionDefineReplacement)
{
  ...
  ASSERT_TRUE(opi::ispair(func_def));
...
TEST_F(SchemeUniqueIdentifiersTest, NestedScopes)
{
  ...
  ASSERT_TRUE(opi::ispair(outer_bindings));
  opi::value outer_binding_x = opi::car(outer_bindings);
  ASSERT_TRUE(opi::ispair(outer_binding_x));
  ...
  ASSERT_TRUE(opi::ispair(inner_body));
...
TEST_F(SchemeUniqueIdentifiersTest, IfExpression)
{
  ...
  ASSERT_TRUE(opi::ispair(condition));
  ...
  ASSERT_TRUE(opi::ispair(then_branch));
  ...
  ASSERT_TRUE(opi::ispair(else_branch));
...
TEST_F(SchemeUniqueIdentifiersTest, ComplexExpression)
{
  ...
  ASSERT_TRUE(opi::ispair(define_expr));
  ...
  ASSERT_TRUE(opi::ispair(if_expr));
  ...
  ASSERT_TRUE(opi::ispair(else_bindings));
  ...
  ASSERT_TRUE(opi::ispair(else_body));
...
TEST_F(SchemeUniqueIdentifiersTest, LetValuesVariableReplacement)
{
  ...
  ASSERT_TRUE(opi::ispair(expr_values));
